...
public class FibonacciNumbers1 {
    public static void main(String[] args) {
        ...
        // }
        long[][] matrix1 = new long[][]{{1},{2},{3}};
        long[][] matrix2 = new long[][]{{1,2,3}};
        printMatrix(matrix1);
        printMatrix(matrix2);
        long[][] result = fibonacciFinder.multiply(matrix1,matrix2);
        printMatrix(result);
...
class FibonacciFinder {
    ...
    private long[][] square(final long[][] matrix) {
     ...
     long[][] multiply(final long[][] matrix1, final long[][] matrix2) {
